...
According to data, 35.61% of refugees in Estonia experiences hostile attitude, that included aggressive comments in news forums online' or
social media, verbal aggression, or physical aggression. In particular, verbal aggression was one of the main concerns, as  14.6% of people reported this from of hostile behavior, followed by aggressive comments on social media and discriminatory behavior accounting for 7% and 6% of responses respectively.
...
**Aid**
Urgent needs first: employment, accommodation, education for adults. Second - medical, material, psychological.
...
#make_prop_table(data_ee$urgent_needs_urgent_needs_third)
#make_prop_table(data_ee$info_needs_info_receive )
...
Reasons for traveling back temporarily: visit relatives, check property, get documents. 77.16% expect to stay in Estonia. 	
