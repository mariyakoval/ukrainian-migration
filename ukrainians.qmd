...
combined_df |>
  filter(!Country %in% c("Hungary", "Bulgaria", "construct", NA)) |>
    ...
    grepl("hous",Component, ignore.case = TRUE) ~ "Accommodation",
    grepl("accom", Component, ignore.case = TRUE) ~ "Accommodation",
    grepl("med", Component, ignore.case = TRUE) ~ "Healthcare",
    grepl("health",Component, ignore.case = TRUE) ~ "Healthcare",
    grepl("prefer", Component, ignore.case = TRUE) ~ "Prefer no answer",
