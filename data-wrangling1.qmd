...
#-------------------------------------------------------
  ...
  unique(combined_data$host_country_diff_work)
diff_dummies <- combined_data |>
  ...
  mutate(host_country_diff_work = str_trim(host_country_diff_work))|>
    ...
    host_country_diff_work %in% c("lack_of_local_language", 
     ...
     host_country_diff_work %in% c("need_to_take_care_of_others", 
                         "lack_childcare") ~ "lack_childcare",
...
combined_data <- combined_data |>
  select(-needs_NA, benefits_NA, diff_NA)
